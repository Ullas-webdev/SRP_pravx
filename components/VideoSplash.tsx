...
export default function VideoSplash() {
  ...
  useEffect(() => {
    // If PageShell skips the loader immediately, it might have already fired or will fire soon.
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex items-center overflow-hidden w-6 h-4">
                  <svg className="absolute left-0 w-4 h-4 text-white transform transition-transform duration-700 ease-[0.16,1,0.3,1] group-hover:translate-x-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                  <svg className="absolute left-0 w-4 h-4 text-white transform -translate-x-8 transition-transform duration-700 ease-[0.16,1,0.3,1] group-hover:translate-x-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                </div>
