            ...
            >
              <span className="w-11 h-11 rounded-full border border-pearl/25 flex items-center justify-center group-hover:border-gold group-hover:text-gold transition-colors duration-300">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.458L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.42 9.864-9.864.002-2.637-1.03-5.115-2.906-6.99C16.653 1.88 14.175.843 11.543.843 6.105.843 1.68 5.263 1.677 10.701c-.001 1.747.458 3.454 1.332 4.965l-1.011 3.69 3.78-.992zm11.702-8.312c-.11-.184-.404-.294-.844-.515-.44-.22-2.59-1.277-2.993-1.423-.403-.147-.697-.22-.99.22-.293.44-1.137 1.423-1.393 1.716-.256.293-.513.33-.953.11-.44-.22-1.859-.685-3.543-2.188-1.31-1.168-2.193-2.61-2.45-3.05-.256-.44-.027-.68.193-.899.198-.197.44-.514.66-.77.22-.257.293-.441.44-.733.147-.294.073-.55-.036-.77-.11-.22-.99-2.385-1.355-3.266-.357-.859-.726-.743-.99-.743-.255-.003-.55-.003-.844-.003-.293 0-.77.11-1.173.55-.403.44-1.54 1.503-1.54 3.665 0 2.162 1.576 4.249 1.796 4.542.22.293 3.1 4.734 7.512 6.643 1.05.454 1.87.725 2.509.927 1.054.335 2.014.288 2.772.175.845-.126 2.59-1.06 2.956-2.083.367-1.023.367-1.9.257-2.083z" />
                </svg>
              </span>
              <span className="text-pearl/75 group-hover:text-gold transition-colors duration-300">
