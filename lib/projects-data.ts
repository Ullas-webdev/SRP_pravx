...
export const PROJECTS: ProjectData[] = [
  ...
  },
  {
    slug: "gwalia",
    client: "Gwalia",
    type: "Sweets and Restaurant Shop",
    area: "3,000 sqft",
    timeline: "45 Days",
    ...
    challenge: [
      ...
      "The challenge was to deliver a complete turnkey solution within a strict 45-day timeline while ensuring perfect aesthetic finishing and food-grade compliance.",
    ],
    srpDifference: [
      "Unlike traditional contractors, SRP provided a single-point turnkey solution, managing everything from specialized HVAC for kitchen exhaust to the ambient lighting in the dining area.",
